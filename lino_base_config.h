...
#define MOTOR_MAX_RPM 800                    // motor's max RPM //stable1 420, stable2  
#define MAX_RPM_RATIO 0.60                  // max RPM allowed for each MAX_RPM_ALLOWED = MOTOR_MAX_RPM * MAX_RPM_RATIO          
...
#define COUNTS_PER_REV1 52                // wheel1 encoder's no of ticks per rev //420:97  570:73
#define COUNTS_PER_REV2 47                // wheel2 encoder's no of ticks per rev //420:86  570:67
...
#define MOTOR3_ENCODER_A 17//17
#define MOTOR3_ENCODER_B 16//16 

#define MOTOR4_ENCODER_A 9//9
#define MOTOR4_ENCODER_B 10//10

// MOTOR PINS
#ifdef USE_GENERIC_2_IN_MOTOR_DRIVER
  #define MOTOR1_PWM 1//21 //Pin no 21 is not a PWM pin on Teensy 4.x, you can swap it with pin no 1 instead.
  #define MOTOR1_IN_A 20//20
  #define MOTOR1_IN_B 21//1 

  #define MOTOR2_PWM 4//5
  #define MOTOR2_IN_A 3//6
  #define MOTOR2_IN_B 8//8

  #define MOTOR3_PWM 22//22
  #define MOTOR3_IN_A 23//23
  #define MOTOR3_IN_B 0//0

  #define MOTOR4_PWM 5//4
  #define MOTOR4_IN_A 6//3
  #define MOTOR4_IN_B 2//2
